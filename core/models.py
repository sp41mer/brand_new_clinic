...
class TreatmentDescriptionModel(models.Model):
    ...
    drugs_decr = models.ForeignKey(MethodDrugsDescription, verbose_name=u'Описание лекартвенных средств', related_name='drugs')
    implant_descr = models.ForeignKey(SuppliesDescriptionModel, verbose_name=u'Описание имплантов', related_name='implant')
    blood_notblood_descr = models.ForeignKey(SuppliesDescriptionModel, verbose_name=u'Описание препаратов крови и кровозаменителей')
